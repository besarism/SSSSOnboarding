...
class PageCell: UICollectionViewCell {
    ...
    private var titleTextView: UITextView = {
        ...
        let attributedString = NSMutableAttributedString(string: "SSSSOnboarding", attributes: [NSAttributedString.Key.font: UIFont.systemFont(ofSize: 20)])
    ...
    func setupViews() {
        ...
        topiImageContainerView.heightAnchor.constraint(equalTo:heightAnchor, multiplier: 0.45).isActive = true
